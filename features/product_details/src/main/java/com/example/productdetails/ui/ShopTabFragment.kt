...
import com.example.productdetails.databinding.ShopTabFragmentBinding

class ShopTabFragment(private val viewModel: ProductDetailsViewModel) : Fragment() {

    lateinit var binding: ShopTabFragmentBinding
    ...
    override fun onCreateView(
        ...
        binding = ShopTabFragmentBinding.inflate(inflater)
        return binding.root
    }
